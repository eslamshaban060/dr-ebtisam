# Dr. Ebtisam Nada – Official Website  

A freelance project for a modern and professional **doctor’s website** built with a strong focus on **SEO, accessibility, and user experience**.  
The platform provides **appointment booking, patient reviews, bilingual support (AR/EN)**, and a **blog for medical articles**, all managed through a powerful **dashboard**.  
...
- **SEO & Metadata:** Fully optimized for search engines  
- **Fonts:** Changa & Poppins  
...
- 📰 **Doctor’s blog** for publishing medical articles  
- 📊 **Admin dashboard** for full control of content & features  

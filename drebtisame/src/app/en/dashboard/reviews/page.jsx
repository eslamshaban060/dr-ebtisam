...
import { reviewsEn } from "../../../../components/ar-components/dashboard/components/data";
import noFeedBackPic from "../../../../../public/user/no-message.png";
import { Sparkles, Ellipsis } from "lucide-react";

const ReviewsPage = () => {
  const [articles, setArticles] = useState(reviewsEn);
      ...
      <section className="h-[75dvh] overflow-y-auto  bg-[var(--lb)] p-2">
        <div className="mwm w-full shadow-[var(--shadow-1)] min-h-[134px] flex flex-col justify-center items-center p-10 gap-5 md:py-0 py-4 rounded-2xl">
          ...
          <p className="md:text-lg text-sm text-[var(--nv)]/60 text-center lg:w-[80%]">
            Welcome, Doctor! In this section, you can follow your patients’
            reviews and feedback to gain insights and improve their experience
            with you
          </p>
        </div>
            ...
            <div className="review-layer rounded-xl  relative h-full px-5 py-6">
              ...
              <div className="absolute right-4 top-1">
                ...
                <button
                  ...
                  } absolute top-8 right-0 bg-[var(--pink)] whitespace-nowrap rounded-xl text-[var(--brown)] px-4 py-2 z-50 font-semibold text-[10px] transform transition-transform duration-200`}
                  onClick={() => {
                    setArticles((prev) =>
